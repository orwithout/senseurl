...
import { createOrbitDB , Documents, Identities, IPFSAccessController } from '@orbitdb/core';
...
class DocumentStore {
  ...
  async init() {
    ...
    console.log('Helia node created with ID:', this.helia.libp2p.peerId.toString())
    ...
    this.db = await  this.orbitdb.open("documents-db");
    ...
    // });
    console.log("Helia object:", this.helia);
    console.log("Blockstore object:", this.helia.blockstore);
